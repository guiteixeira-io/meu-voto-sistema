...
// Array completo com todos os presidentes (movido para fora do componente)
const allPoliticians = [
  ...
  },
  {
    ...
    name: "Jair Bolsonaro",
    party: "PL",
    position: "38º Presidente da República (2019-2022)",
    photo: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400",
    age: "69 anos",
    location: "São Paulo - SP",
    experience: "Militar e deputado federal",
    biography:
      "Militar e político paulista, foi deputado federal por 28 anos antes de se tornar presidente. Seu governo foi marcado pela pandemia de COVID-19 e polarização política.",
    tags: [
      "MilitarPolítico",
      "DeputadoFederal",
      "PandemiaCOVID",
