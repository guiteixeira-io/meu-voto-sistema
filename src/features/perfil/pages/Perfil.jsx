// Página Perfil: Recebe o conteúdo do Dashboard
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 2xl:grid-cols-3 gap-6">
        ...
        <div className="2xl:col-span-2 space-y-6">
          ...
          {/* Botão Sair abaixo de Próximas Eleições */}
          <div className="flex justify-end mt-8">
            <button
              onClick={handleLogout}
              className="flex items-center px-4 py-2 text-sm font-medium text-red-700 hover:bg-red-50 rounded-md transition-colors"
            >
              <svg
