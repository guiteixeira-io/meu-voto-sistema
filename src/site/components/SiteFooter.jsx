...
const SiteFooter = () => {
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: "Entrar no Sistema", href: "/sistema" },
      ],
    },
    {
      title: "Recursos",
  ...
  const socialLinks = [
    { icon: Twitter, href: "https://twitter.com/meuvoto.social", label: "Twitter" },
    {
      icon: Instagram,
      href: "https://instagram.com/meuvoto.social",
      label: "Instagram",
    },
    { icon: Github, href: "https://github.com/guiteixeira-io/meu-voto-sistema", label: "GitHub" },
    { icon: Mail, href: "mailto:contato@meuvoto.social.br", label: "Email" },
  ];
